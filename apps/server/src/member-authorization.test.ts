...
const memberEmail = process.env.MEMBER_USER_EMAIL;
const memberPassword = process.env.MEMBER_USER_PASSWORD;
const memberOrganizationId = process.env.MEMBER_ORGANIZATION_ID;
