...
assert.match(
  mainTerraform,
  /depends_on\s*=\s*\[[\s\S]*google_secret_manager_secret_iam_member\.server_runtime_secrets/,
);
assert.match(
  mainTerraform,
  /depends_on\s*=\s*\[[\s\S]*google_secret_manager_secret_iam_member\.mcp_ai_runtime_secrets/,
);
assert.match(
  mainTerraform,
